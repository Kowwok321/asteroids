...
class Player(CircleShape):
    ...
    def draw(self, screen):
        ...
        pygame.draw.polygon(screen, "white", triangle_list, LINE_WIDTH)
    ...
    def shoot(self):
        ...
        a, b = self.position
        current_shot = Shot(a, b, SHOT_RADIUS)
        shot_vector = pygame.Vector2(0, 1).rotate(self.rotation)
        shot_vector *= PLAYER_SHOOT_SPEED
        current_shot.velocity = shot_vector